...
//        mList.addAll(list);
    ...
    class CartViewHolder extends RecyclerView.ViewHolder {
        ...
        public void bind(int position) {
            ...
            GoodsDetailBean details = mList.get(position).getGoods();
            if (details != null) {
            ...
            mCbSelect.setChecked(mList.get(listPosition).isChecked());
        ...
        public void onClick(View view) {
            switch (view.getId()) {
                case R.id.iv_add:
                    model.updateCart(mContext, I.ACTION_CART_ADD, mUser.getMuserName(), mList.get(listPosition).getGoodsId(), 1,
                            mList.get(listPosition).getId(), new OnCompleteListener<MessageBean>() {
                                @Override
